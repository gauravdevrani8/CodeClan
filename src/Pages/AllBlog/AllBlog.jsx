                    ...
                    <div className="flex flex-wrap justify-center -m-4 mb-5">
                        {getAllBlog.length > 0 ? (
                            getAllBlog.map((item, index) => {
                                const { thumbnail, id, date, blogs } = item; // Ensure `blogs` is destructured
                                        ...
                                        >
                                            ...
                                            <div className="p-6">
                                                ...
                                                <h1 className="title-font text-lg font-bold text-gray-900 mb-3" style={{ color: mode === 'dark' ? 'rgb(226, 232, 240)' : 'rgb(30, 41, 59)' }}>
                                                    {blogs && blogs.title ? blogs.title : 'No title available'} {/* Check if blogs exists */}
                                                </h1>

                                                {/* Blog Description */}
                                                <p className="leading-relaxed mb-3" style={{ color: mode === 'dark' ? 'rgb(226, 232, 240)' : 'rgb(30, 41, 59)' }}>
                                                    {blogs && blogs.description ? blogs.description : 'No description available.'} {/* Check if description exists */}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
